  ...
  if (!localConfig) {
    return (
      <div className="text-center py-12">
        <TrendingUp className="w-12 h-12 text-stone-300 dark:text-stone-700 mx-auto mb-4" />
        <p className="text-stone-600 dark:text-stone-400 text-sm mb-4">
          Analytics integration is optional. You can configure it later in Settings.
        </p>
      </div>
    )
  }
